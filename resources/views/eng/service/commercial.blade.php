...
<div class="pt-5"
    style="height: auto; min-height: 40rem; background-image: url('{{ env('APP_URL') . $commercial->background }}'); background-size: cover; align-items: center;">
    <div class="container" style="background-color: rgba(0, 0, 0, 0.8); color: white;margin-top:100px">
        <div class="row py-3 px-4">
            <div class="col-sm-12">
                <h2 class="fw-bold text-left py-4">{{ $commercial->title }}</h2>
                <p style="text-align: justify!important">
                    {!! $commercial->description_eng !!}
                </p>
                <hr class="py-6 px-4"
