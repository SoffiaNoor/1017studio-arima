...
<body id="page-top">
    ...
    <div data-aos="fade-up" data-aos-duration="1000" class="h-auto py-5" style="background-color:#e6e6e6;align-content: center;">
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    <img src="{{asset('assets/img/why choose us.png')}}" style="width:100%" />
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <p style="text-align: justify">{{$information->description_eng}}</p>
                </div>
            </div>
        </div>
    </div>
                            ...
                            <div class="card" style="width: auto;max-width:25rem;border: none;border-radius: 0;">
                                <div class="card-body">
                                    ...
                                    <div style="background:#e6e6e6;display: flex; flex-wrap: wrap;min-height:500px">
                                        <p style="font-weight:500" class="card-text py-2 px-4">{{$pm->description_eng}}
                                        </p>
                                        <div class="py-2">
                ...
                <div class="col-sm-12">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4 py-2" style="text-align: -webkit-center;">
                            <a href="{{ route('news.show_eng', $ln->id) }}" class=card-for-news>
                                <div class="card"
                                    ...
                                    <div style="background:#ec1e22;min-height:80px;place-content: center;">
                                        <h5 class="text-white fw-bold text-center py-2 px-5">{{$ln->title_eng}}
                                        </h5>
                                    </div>
                                </div>
                            </a>
