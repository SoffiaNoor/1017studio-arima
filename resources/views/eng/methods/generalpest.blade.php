...
<div
    style="height: 40%; min-height: 30%; background-image: url('{{ env('APP_URL') . $generalpest->header_image }}'); background-size: cover;">
</div>
<div class="pt-3">
    <div class="container">
        <div class="row py-3 px-4">
            <div class="col-sm-12">
                <h2 class="fw-bold text-left py-4">{{ $generalpest->title }}</h2>
                <p style="text-align: justify!important">
                    {!! $generalpest->description_eng !!}
                </p>
            </div>
            <div class="col-sm-12">
                <div class="row">
